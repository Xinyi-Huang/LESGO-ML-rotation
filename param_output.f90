...
use level_set_base
#endif
! Xinyi - WM - suggestion : You might want to output the parameters used for
! wall model of rotating channels
...
write(2,i_fmt) 'ubc_mom : ', ubc_mom       ! output Xinyi's flag for upper boundary layer.
write(2,f_fmt) 'zo : ', zo
write(2,l_fmt) 'inflow : ', inflow
write(2,l_fmt) 'initial_uniform : ', initial_uniform  ! output Xinyi's initial uniform flow switch
...
write(2,f_fmt) 'initial_velocity_const : ', initial_velocity_const ! output Xinyi's initial scaling constant
